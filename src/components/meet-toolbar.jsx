        ...
        return (
            <div id="header">
                <span id="toolbar" className={this.props.isHidden ? "toolbarHide" : "toolbarShow"}>
                  ...
                  <a className="button" onClick={this.props.onChat}><i className="fa fa-comments" style={!this.props.isChatAvailable ? {color: 'gray'} : {}} aria-hidden="true">{this.props.newMessageCount > 0 ? <span className="badge" style={{color: 'white', background: 'red'}}>{this.props.newMessageCount}</span> : null}</i></a>
