  ...
  render() {
    ...
    return (
      <AvatarComponent
        ...
        onClick={() =>this.clickHandler(this.props.type, this.props.id, this.props.domId, true, this.props.localVideos, this.props.remoteVideos, this.props.switchingEnabled)}>
      </AvatarComponent>
    )
  }
}
